...
2. Install Dependencies:
   ...
   • Development: pnpm add -D prisma typescript tsx @types/express @types/ws
...
Finally, execute your initial migration and generate the client: pnpm prisma migrate dev --name init and
...
In your main entry point (src/index.ts), ensure dotenv is the first line imported to load environment
variables before the database client initializes.
